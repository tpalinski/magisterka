...
\subsection{Ewaluowane modele embeddingowe}
...
W ramach obliczania metryki MMD (\ref{eq:MMD}), skorzystano z liniowej funkcji jądra $k(x_1, x_2)$:
\begin{equation}
    k_{\text{lin}}(x, y) = x^y
\end{equation}
