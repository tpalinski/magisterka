...
Kolejnym istotnym krokiem w rozwoju systemów rozpoznawania mowy był model \textbf{Whisper}\cite{whisper}. W przeciwieństwie do modelu \textbf{Wav2Vec 2.0}, który uczy się reprezentacji bezpośrednio z surowego sygnału audio, Whisper wykorzystuje melspektrogramy, stanowiące przetworzoną reprezentację częstotliwościową sygnału. Zastosowanie takiej reprezentacji pozwala wstępnie przetworzyć sygnał i uwypuklić istotne informacje akustyczne, ograniczając jednocześnie wpływ nieistotnych składowych, takich jak szum. Dzięki temu model może koncentrować się na modelowaniu bardziej złożonych zależności między informacją akustyczną a kontekstem językowym.
