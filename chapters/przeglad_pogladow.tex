...
Podejścia jakościowe koncentrują się na rozkładzie reprezentacji na komponenty poddające się interpretacji. Punktem wyjścia jest obserwacja, że pojedyncze neurony sieci są zazwyczaj polisemantyczne, to znaczy aktywują się w odpowiedzi na wiele niepowiązanych ze sobą zjawisk. Wynika to z superpozycji cech w przestrzeni o ograniczonej wymiarowości. Bricken et al. wykazali, że rzadkie autoenkodery (ang. \textit{sparse autoencoders}, SAE) trenowane na aktywacjach modelu językowego pozwalają na rozłożenie ich na słownik cech znacznie bliższych monosemantyczności \cite{bricken2023monosemanticity}. Wyniki te zostały potwierdzone i rozszerzone w pracy Hubena et al., w której wykazano wyższą interpretowalność cech uzyskanych metodą SAE w porównaniu z alternatywnymi metodami dekompozycji \cite{huben2024sparse}.
