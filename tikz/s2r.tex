...
\node[model, right=0.7cm of audio] (enc) {Enkoder ASR};
\node[data, right=0.7cm of enc] (latent) {Reprezentacja\\ukryta};
\node[model, right=0.7cm of latent] (agg) {Agregacja\\sekwencji};
\node[adapt, right=0.7cm of agg] (proj) {Warstwa projekcji\\(adapter)};
\node[data, right=1.1cm of proj] (qvec) {Wektor\\zapytania};
...
% ============================================================
\node[data, above=1.6cm of proj] (docs) {Dokumenty\\tekstowe};
